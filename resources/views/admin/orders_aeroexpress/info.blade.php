                    ...
                    <table class="table table-striped table-bordered table-hover" width="100%">
                        ...
                        @foreach($documents as $document)
                            <tr>
                                ...
                                <td>{{ isset($document['TariffType']) ? trans('references/im.aeroexpressPassengerResponse.TariffType.' . $document['TariffType']):'' }}</td>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover tablesaw-swipe"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-tablesaw-sortable-col  data-tablesaw-priority="persist">{!! trans('references/im.aeroexpressReservationResponse.OrderItemId') !!}</th>
                                <th>{!! trans('references/im.aeroexpressReservationResponse.Amount') !!}</th>
                                <th>{!! trans('references/im.aeroexpressReservationResponse.Fare') !!}</th>
                                <th>{!! trans('references/im.aeroexpressReservationResponse.Tax') !!}</th>
                                <th>{!! trans('references/im.aeroexpressReservationResponse.ReservationNumber') !!}</th>
                                <th>{!! trans('references/im.aeroexpressReservationResponse.ConfirmTill') !!}</th>
                                <th width="180px">{!! trans('references/im.aeroexpressReservationResponse.ClientFeeCalculation') !!}</th>
                                <th>{!! trans('references/im.aeroexpressReservationResponse.AgentFeeCalculation') !!}</th>
                            </tr>
                            </thead>
                            <tbody>
