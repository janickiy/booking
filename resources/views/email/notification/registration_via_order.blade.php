    ...
    <table width="100%" style="padding:0;margin:0;border:none;cellpadding:0;cellspacing:0;">
        <tr>
            ...
            <td style="padding:0;padding-bottom:45px;margin:0;border:none;cellpadding:0;cellspacing:0;vertical-align: top;">
                ...
                <div style="color:#333333;font-size:15px;font-family:roboto,arial,sans-serif;margin-bottom: 15px;">
                    Для входа в личный кабинет и работы с бронированиями, Вам необходимо задать пароль Вашей учётной записи.
                </div>
                <div style="color:#333333;font-size:15px;font-family:roboto,arial,sans-serif;">
                    Для этого пройдите по <a href="#">ссылке</a> и завершите регистрацию.
                </div>
            </td>
        </tr>
