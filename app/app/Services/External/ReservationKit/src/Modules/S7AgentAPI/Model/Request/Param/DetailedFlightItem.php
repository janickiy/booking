...
class DetailedFlightItem extends XmlElement
{
    /**
    ...
    public function __construct(array $segments)
    {
        ...
        foreach ($waysList as $waySegments) {
            $OriginDestinationList[] = new XmlElement('OriginDestination', array(), HelperRequest::getListRequestParam('FlightForBooking', $waySegments), 'ns1');
        }

        parent::__construct('DetailedFlightItem', array(), $OriginDestinationList, 'ns1');
    }
}