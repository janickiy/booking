...
class AgentUserSender_QA extends XmlElement
{
    public function __construct($isContact = false, $isSitaPOS = false, $version = '0.50')
    {
        if ($version === '0.50') {
            ...
            if ($isContact) {
                $contentAgentUserSender[] =
                    new XmlElement('Contacts', array(), array(
                        new XmlElement('Contact', array(), array(
                            new XmlElement('PhoneContact', array(), array(
                                new XmlElement('Application', array(), 'TEST BOOK', 'ns1'),
            ...
            $contentAgentUserSender[] = new XmlElement('PseudoCity', array(), 'OVBS728AB', 'ns1');
            $contentAgentUserSender[] = new XmlElement('AgentUserID', array(), 'WSS72API', 'ns1');
